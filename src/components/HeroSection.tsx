...
import professionalHeadshot from "/lovable-uploads/19d9ad75-3896-47c9-9efa-70611a88179e.png";
const HeroSection = () => {
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              <div className="w-80 h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden border-4 border-accent/20 shadow-2xl">
                <img src={professionalHeadshot} alt="Anita Odiete - Professional Headshot" className="w-full h-full object-cover" />
              </div>
              {/* Decorative elements */}
