...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center bg-background pt-16">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                ...
                className="bg-primary hover:bg-primary-light text-primary-foreground flex items-center gap-2"
              >
              ...
              <Button
                ...
                className="border-secondary text-secondary hover:bg-secondary hover:text-secondary-foreground flex items-center gap-2"
              >
            ...
            <div className="relative">
              <div className="w-80 h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden border-4 border-accent/20 shadow-2xl">
                <img
                  ...
                  alt="Anita Ogbonna - Professional Headshot"
