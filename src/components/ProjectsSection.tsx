  ...
  const productProjects = [
    {
      ...
      impact: "Hardware concept → build-ready digital ecosystem",
       tags: ["Connected Health", "0→1 Product ", "FemTech", "Product Operating Systems", "Cross-Functional Leadership", "UX Architecture", "AI Governance & Guardrails", "Product Analytics"]
    },
    {
  ...
  const sustainabilityProjects = [
    ...
    },
    {
      ...
      description: "Designed a scalable Recycling Village model for Edo State, integrating waste-to-energy, green manufacturing, and ESG-aligned governance. Developed the full business case, PPP model, and investment roadmap for green jobs and carbon reduction.",
       impact: "6,500+ trained across 6 states",
    ...
    },
    {
      ...
      linkUrl: "https://www.atunlotech.com/",
       ...
       tags: ["Climate Tech", "Circular Economy", "Program Management", "Fundraising", "P&L Ownership", "Environmental & Social Impact"]
    }
  ];
