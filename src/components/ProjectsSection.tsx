  ...
  const productProjects = [
    {
      ...
      tags: ["Hardware concept", "Build-Ready Digital Ecosystem", "FemTech", "Product Operating Systems", "Cross-Functional Leadership", "UX Architecture", "AI Governance & Guardrails", "Product Analytics"]
    },
    {
